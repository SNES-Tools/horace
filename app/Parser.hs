...
happyExpList = Happy_Data_Array.listArray (0,20) ([16528,0,36888,1408,9225,0,1,0
	])
...
action_3 (6) = happyShift action_6
action_3 (7) = happyShift action_7
...
action_5 (6) = happyShift action_6
